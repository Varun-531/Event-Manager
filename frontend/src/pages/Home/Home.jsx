...
const Home = () => {
  ...
  return (
    <div className="container-1 p-[2%] px-[10vw]">
        ...
        {login && (
          <button className="float-right bg-slate-900 p-1 rounded text-base px-2 login-button"> <Link to="/" onClick={handleLogout}>Logout</Link>
          </button> )}
      ...
      <div className="flex flex-col justify-center items-center mt-[25vh]">
        ...
        {!login ? (<button className="home-button" onClick={handleLogin}>Get Started</button>):(<button className="home-button" onClick={handleDash}>
            Dashboard
          </button>)}
